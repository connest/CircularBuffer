...
TEST(circular_buffer_blocked_tests, copy_constructor_buffer)
{
    // Arrange

    connest::CircularBuffer_mrmw_blocked<int> forCopy(10);
    forCopy.try_push_back(1);
    forCopy.try_push_back(2);
    forCopy.try_push_back(3);
    forCopy.try_push_back(4);

    int value{};

    // Act
    connest::CircularBuffer_mrmw_blocked<int> copy(forCopy);
...
TEST(circular_buffer_blocked_tests, move_constructor_buffer)
{
    // Arrange

    connest::CircularBuffer_mrmw_blocked<int> forMove(10);
    forMove.try_push_back(1);
    forMove.try_push_back(2);
    forMove.try_push_back(3);
    forMove.try_push_back(4);

    int value{};

    // Act
    connest::CircularBuffer_mrmw_blocked<int> copy(std::move(forMove));
