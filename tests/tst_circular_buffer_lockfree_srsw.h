...
TEST(circular_buffer_tests, copy_constructor_buffer)
{
    ...
    connest::CircularBuffer_srsw<int> forCopy(10);
    ...
    // Act
    connest::CircularBuffer_srsw<int> copy(forCopy);
...
TEST(circular_buffer_tests, move_constructor_buffer)
{
    ...
    connest::CircularBuffer_srsw<int> forMove(10);
    ...
    // Act
    connest::CircularBuffer_srsw<int> copy(std::move(forMove));
